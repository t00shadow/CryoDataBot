...
from frontend_gui_assets.guiskin import Ui_MainWindow

import frontend_gui_assets.GUI_custom_widgets.z_Tag_main_alt_allcode_v2 as TTEwidget2
from frontend_gui_assets.GUI_custom_widgets.LabelComboBox import LabelComboBox
from frontend_gui_assets.GUI_custom_widgets.LabelComboBox_v2 import LabelComboBox_v2
import frontend_gui_assets.GUI_custom_widgets.commaLineEdit as LabelLineEdit
from frontend_gui_assets.GUI_custom_widgets.animated_toggle import AnimatedToggle
from frontend_gui_assets.GUI_custom_widgets.popupDialog_alt import PopupDialog
from frontend_gui_assets.GUI_custom_widgets.easyCloseDialog import EasyCloseDialog
...
class MainWindow(qtw.QMainWindow):    # Make sure the root widget/class is the right type (can check in designer or the .ui file)
    ...
    def add_group_w_del_btn(self):
        ...
        # group_delbtn.setIcon(qtg.QIcon(r"src/frontend_gui_assets/GUI_custom_widgets/svgs/browsefilesicon.png"))
        group_delbtn.setIcon(qtg.QIcon(r"src/frontend_gui_assets/GUI_custom_widgets/svgs/clear_inverse-svgrepo-com.svg"))
        ...
        "    border-image: url(src/frontend_gui_assets/GUI_custom_widgets/svgs/clear_inverse-svgrepo-com.svg);\n"  # border-image vs image?
        "}\n"
        "\n"
        "QPushButton:pressed {\n"
    ...
    def add_label_custom(self):
        ...
        label_delbtn.setIcon(qtg.QIcon(r"src/frontend_gui_assets/GUI_custom_widgets/svgs/clear_inverse-svgrepo-com.svg"))
