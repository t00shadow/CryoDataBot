...
class MainWindow(qtw.QMainWindow):    # Make sure the root widget/class is the right type (can check in designer or the .ui file)
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.ui.qScoreInfo_btn.clicked.connect(lambda: self.show_tooltip_on_click("QScore: descrip... *consider using richtext (if possible) to have colors and bold, italics, etc"))
        self.ui.mmfInfo_btn.clicked.connect(lambda: self.show_tooltip_on_click("Our calculated metric: ...what this means..."))
        self.ui.simInfo_btn.clicked.connect(lambda: self.show_tooltip_on_click("Similarity: Measure of how similar _ are. 100 is most similar, 0 is least similar"))
        ...
        self.ui.qScoreInfo_btn_3.clicked.connect(lambda: self.show_tooltip_on_click("This step proprocesses... NOTE: Maps and models are downloaded in this step."))
