...
class Sidebar(QWidget):
    def __init__(self):
        ...
        self.setMinimumWidth(100)  # Set the minimum width for the sidebar
...
class MainApp(QWidget):
    def __init__(self):
        ...
        self.splitter.setCollapsible(0, False)  # Last widget is collapsible
        ...
        self.setWindowTitle('Spotify-like Sidebar Collapse Example (my fav tbh)')
